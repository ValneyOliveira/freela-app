    ...
    <div>
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogTrigger asChild>
            <Button variant={!client ? "outline" : undefined} className={`${!client && "bg-blue-500 hover:bg-blue-400 hover:text-while text-white"} ${client?.id && "text-black bg-neutral-50 hover:bg-neutral-100"} border-1 hover:cursor-pointer`}>
